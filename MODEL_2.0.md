...
This dashboard repo only displays Neon `scan_snapshots`. Model 2.0 math lives in `Modeling/` (`propmodel` / `model`). Dashboard work lands in **Phase 5** (edge-vs-fair display, tier sync, CLV-by-tier on Tracker).
